...
SELECT '001', 'Sultaan Faatix', 'Hani Cumar Maxamuud', c.id, y.id, 'waxaad muujisay karti iyo dedaal aad u wanaagsan. waxaad ku guulaysatay inaad noqoto ardayda ugu fiican fasalka! ðŸŽ‰Horumar wanaagsan!', TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '11', 'Sahro Cabdullaahi Cali', 'Naciimo Maxamed Xasan', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 2' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 95.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '67', 'Shukri Cabdicaziiz Axmed', 'Hooyo Culumo C//lle Calasow', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 2' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 96.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '78', 'Xabiiba Ibraahim Maxamed', 'Hooyo Faadumo Maxamed Abuukar', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 2' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 96.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '47', 'Maryan Abshir Aadan', 'Hooyo Naciimo Maxamed Xasan', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 1' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 91.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '5', 'Ruweydo Cabdullaahi Axmed', 'Hooyo Maryan Isaaq Cali', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 1' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 89.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '36', 'Sacdiyo Sayid Maxamed', 'Hooyo Khadiijo Cabdullaahi Ibraahim', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = 'Form 1' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 93.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '122', 'Maryan Daahir Xuseen', 'Hooyo Zeynab Muuse Maxamed', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '8aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '109', 'Maxamed Cabdullaahi Yuusuf', 'Hooyo Xakiimo Maxamed Cumar', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '8aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '119', 'Xasan Yuusuf Maxamed', 'Hooyo Carfoon Nuur Wehliye', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '8aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '68', 'Cabdiwali Sayid Cali Maxmuud', 'Hooyo Khadiijo C/Laahi Ibraahim', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '7aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 100.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '142', 'Salmaan Cabduqaadir Maxamed', 'Hooyo Kaltuumo Aweys Abaadir', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '7aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 99.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '89', 'Zamzam Saciid Maxmuud', 'Hooyo Sacdiyo Xasan Maxamed', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '7aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 92.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '49', 'Cabaas Maxamed Aweys', 'Hooyo Ruun Muqtaar Muuse', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '6aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 88.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '84', 'Istar Cabdullaahi Maxamed', 'Hooyo Aamino Maxamed Yuusuf', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '6aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 77.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '80', 'Salmo Sayid Cali Maxmuud', 'Hooyo Khadiijo Cabdullaahi Ibraahim', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '6aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 87.00, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '50', 'Shukri C/lle Maxamed', 'Hooyo Bishaaro Axmed Cadaan', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 3aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '5aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 67.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '110', 'Mukhtaar Maxmuud Maxamed', 'Hooyo Hidaayo Axmed Abiikar', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 2aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '5aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 63.50, TRUE
...
ON DUPLICATE KEY UPDATE score = VALUES(score), is_published = VALUES(is_published);
INSERT INTO students (student_code, full_name, mother_name, class_id, academic_year_id, note, is_active)
SELECT '23', 'Iidow Maxamed Maxmuud', 'Hooyo Xaliimo Aamin Axmed', c.id, y.id, 'Hambalyo! Waxaad muujisay karti iyo dedaal aad u wanaagsan. Waxaad ku guulaysatay inaad kaalinta 1aad u gasho fasalkaaga. Horumar wanaagsan! ðŸŽ‰ðŸŽ‰', TRUE
FROM school_classes c JOIN academic_years y WHERE c.name = '5aad' AND y.name = '2024-2025'
ON DUPLICATE KEY UPDATE full_name = VALUES(full_name), mother_name = VALUES(mother_name), class_id = VALUES(class_id), academic_year_id = VALUES(academic_year_id), note = VALUES(note);
INSERT INTO results (student_id, exam_id, subject_id, score, is_published)
SELECT st.id, ex.id, su.id, 67.50, TRUE
